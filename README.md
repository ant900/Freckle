...
1.	**Cocoapods:**
	...
	After installing the SDK, follow the steps in Project Settings. Ignore [Build Settings](#Build Settings), Link the Framework, and Linking the Bundle Resources section.
