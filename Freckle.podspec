#
#  Be sure to run `pod spec lint Freckle.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #   s.description  = "The Freckle SDK enables any iOS application to participate in the Freckle open beacon ecosystem."
  ...
  s.author             = { "kaitung123" => "tomcheung_123@hotmail.com" }
  # Or just: s.author    = "kaitung123"
  # s.authors            = { "kaitung123" => "tomcheung_123@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/kaitung123"
  ...
  # s.resources = "FreckleSDK.framework/Resources/FreckleSDK.bundle"
